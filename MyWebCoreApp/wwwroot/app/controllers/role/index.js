    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        dkteam.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        dkteam.notify('Has an error', 'error');
                        dkteam.stopLoading();
                    }
                });
                return false;
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    dkteam.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    dkteam.stopLoading();
                },
                error: function () {
                    dkteam.notify('Has an error in save permission progress', 'error');
                    dkteam.stopLoading();
                }
            });
        });
